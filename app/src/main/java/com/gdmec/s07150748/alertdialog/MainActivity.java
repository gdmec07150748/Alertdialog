package com.gdmec.s07150748.alertdialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void dialog4() {
       final String item[] = new String[]{"北京","上海","广州"};
        ...
        DialogInterface.OnMultiChoiceClickListener lis4 = new DialogInterface.OnMultiChoiceClickListener(){
            @Override
            public void onClick(DialogInterface dialoge, int which, boolean isChecked) {
    ...
    private void dialog5() {
        ...
        ad.setButton(DialogInterface.BUTTON_NEGATIVE,"确定",lis51);
        ad.show();
    }
